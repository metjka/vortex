...
public class FunctionMenu extends StackPane implements ComponentLoader {
    ...
    public FunctionMenu(boolean byMouse, ToplevelPane pane) {
        ...
        Button reverseBlock = new MenuButton("Reverse", bm -> addBlock(new ReverseBlock(parent)));
        ...
        utilSpace.getChildren().addAll(closeButton, outputBlock, constantBlock, mathBlock, imageBlock, convolutionBlock,
                imagePreviewBlock, invertBlock, greyscaleBlock, reverseBlock, sobelBlock, sepiaBlock, rotateBlock);
